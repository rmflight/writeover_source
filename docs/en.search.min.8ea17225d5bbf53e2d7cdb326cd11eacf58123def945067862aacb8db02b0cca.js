...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/symbiosisnovel/flexsearch.min.js');loadScript('/symbiosisnovel/en.search-data.min.8aeaf557ced0d1e8a5dc285d3e670e79ac80cd3d98bb57d89df716b8098f4677.js',function(){input.required=false;search();});}
