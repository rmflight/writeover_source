...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/symbiosisnovel/flexsearch.min.js');loadScript('/symbiosisnovel/en.search-data.min.0e0c57b0386ed1634f296591409aca6f7076228e4ed2657247814486b700213a.js',function(){input.required=false;search();});}
