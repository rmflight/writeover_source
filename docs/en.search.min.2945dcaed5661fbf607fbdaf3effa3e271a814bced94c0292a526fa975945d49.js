...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/symbiosisnovel/flexsearch.min.js');loadScript('/symbiosisnovel/en.search-data.min.2974c74d3f36880f7df7e0a4248ac78dd6c33c525073e43d4e1661757f01a1e1.js',function(){input.required=false;search();});}
